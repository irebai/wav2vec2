...
from module.trainer import DataCollatorS2SWithPadding, CTCTrainer
from module.tokenizer import (
    Wav2Vec2CTCTokenizer_CHAR,
    Wav2Vec2CTCTokenizer_SP,
)
from module.model_S2S import Wav2Vec2ForS2S
...
def main():
    ...
    # Model load
    model = Wav2Vec2ForS2S.from_pretrained(
    ...
    data_collator = DataCollatorS2SWithPadding(processor=processor, augmenter=augmenter, padding=True)
