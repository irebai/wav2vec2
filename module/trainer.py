...
class CTCTrainer(Trainer):
    ...
    def create_scheduler(self, num_training_steps: int):
        ...
        def lr_lambda(current_step):
            warmup_steps = math.ceil(num_training_steps * self.args.lr_warmup_ratio)
            constant_steps = math.ceil(num_training_steps * self.args.lr_constant_ratio)
            if current_step < warmup_steps:
                ...
                ) # decrease the LR [1 > 0] (linearly decay)
